...
1. <a href="../../../disciplines/statistical/statisticalsignalprocessing_spectrum_intro_distribution">Introduction to spectral estimation</a> In order to cover the topic of spectral estimation, it is important that to review topics such as the Fourier transform and calculation of the power spectrum for energy and power signals. In practice, however, all real-world signals are windowed, which leads to several consequences when calculating the power spectrum.
...
3. /statisticalsignalprocessing_spectrum_parametric">Parametric methods</a> - Another methodology involves the modelling of the frequency spectrum through the use of several parameters. The parameters define the shape of the spectrum and by learning these parameters, the true spectrum can be estimated.
