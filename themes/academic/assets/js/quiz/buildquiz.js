...
function buildQuiz(questions, options, currentQuiz){
    ...
    output.push(
        ...
        <button id="previous" class="button button-previous"><svg class="button-icon"><use xlink:href="/files/11.Quiz/svg/angle-left.svg#example"></use></svg> previous </button>
        <button id="next" class="button button-next"> next <svg class="button-icon"><use xlink:href="/files/11.Quiz/svg/angle-right.svg#example"></use></svg></button>
